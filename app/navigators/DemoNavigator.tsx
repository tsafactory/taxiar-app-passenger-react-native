...
import { DemoCommunityScreen, DemoShowroomScreen, DemoDebugScreen, CreateCarsScreen } from "../screens"
...
export function DemoNavigator() {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        name="CreateCars"
        component={CreateCarsScreen}
        options={{
          tabBarIcon: () => <Icon icon="heart" size={30} color="#333" />,
          title: "Create Cars",
        }}
      />
